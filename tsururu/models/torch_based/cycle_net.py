...
class CycleNet_NN(DLEstimator):
    ...
    def forward(self, x):
        ...
        series = slice_features(x, ["series"], self.features_groups_corrected) # [batch_size, seq_len, num_series]
        ...
        if self.channel_independent:
            ...
            z = torch.cat([series.unsqueeze(-1), exog_features], dim=3) # [batch_size, seq_len, num_series, features_per_series]
